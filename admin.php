				...
				<div class="grid_row">
					...
					<ul class="header__navbar-list">
						...
						<li class="header__navbar-item">
							...
							<a href="" class="header__navbar-link" ><i class="header__navbar-icon fab fa-facebook"></i></a>
							<a href="" class="header__navbar-link"><i class="header__navbar-icon fab fa-youtube"></i></a>
							<a href="" class="header__navbar-link"><i class="header__navbar-icon fab fa-instagram"></i></a>
					...
					<ul class="header__navbar-list">
						...
						<li class="header__navbar-item header__navbar-item--bold">
							<i class="icon-user far fa-user-circle"></i>
							<?php session_start();
									$user = $_SESSION["username"]; echo $user; ?>
							<div class="logout">
								<a class="text-logout" href="index.php">
						...
						$query = mysqli_query($connect,$sql);
							...
							<?php
								...
								while($row = mysqli_fetch_assoc($query)){ ?>
									...
									<div id = "<?php echo $row['id'] ?>" class="grid__column-1-5">
