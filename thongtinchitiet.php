					...
					<?php
						...
						while($row = mysqli_fetch_assoc($query)){ ?>
								...
								<div class="product-detail">
									<img src="./img/<?php echo $row['img'] ?>" alt="" class="product_img">
									<div class="content">
										<h3 class="product-name"><?php echo $row['name'] ?></h3>
										<div class="product-price">Giá Tiền :  <?php echo $row['price'] ?> VNĐ</div>
										<div class="product-type">Phân Loại : <?php echo $row['type'] ?></div>
										<p class="product-description">Mô tả sản phẩm : <?php echo $row['description'] ?></p>
										<div class="content-control">
											<button id="btn_buy" class="btn btn--registry btn-buy">Mua ngay</button>
											<a href="index.php"><button class="btn btn_exit">Trở lại</button></a>
										</div>
									</div>
								</div>
...
<!--	form điền thông tin khách hàng mua sp-->
	<div id="thongtinkhachhang" class="modal">
		<div class="modal__background">			
			...
			<div class="modal__body">
				<div class="modal__content">
					...
					<form method="post" action="khachhang.php?id=<?php echo $a; ?>" onSubmit="return check_form_khach()" enctype="multipart/form-data">
						<div class="form">
							
							<h2 class="form-header">Điền thông tin khách hàng</h2>
							<div class="form-group">
								<label for="">Họ tên:</label>
								<input id="name_kh" class="form__input" type="text" name = "name_kh" required>
								<p id="err_name_kh" style="color: red" align="left"></p>
							</div>
							<div class="form-group">
								<label for="">SĐT:</label>
								<input id="input_sdt" class="form__input" type="text" name = "sdt" required>
								<p id="err_sdt_kh" style="color: red" align="left"></p>
							</div>
							<div class="form-group">
								<label for="">Địa chỉ:</label>
								<input id="address_kh" class="form__input" type="text" name = "diachi" required>
								<p id="err_address_kh" style="color: red" align="left"></p>
							</div>
							
							<div class="form__control-btn">
								<button  type="submit" class="btn btn-add">MUA NGAY</button>
								<button type="button" id="form_close_buy" class="btn">TRỞ LẠI</button>
							</div>
	...
	<script src="./js/check_form_buy.js"></script>
</body>
</html>
